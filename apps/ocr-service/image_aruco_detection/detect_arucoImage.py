...
def process_image(image_path, output_path):
    ...
    # Step 4: Sort markers by position
    marker_positions = []
    ...
    # Save processed thresholded image
    output_folder = os.path.dirname(output_path)
    os.makedirs(output_folder, exist_ok=True)
    threshold_path = os.path.join(output_folder, "thresholded_image.png")
    cv2.imwrite(threshold_path, processed)
    print("✅ Thresholded image saved to:", threshold_path)
